  ...
  ar: {
    ...
    projects: {
      ...
      items: [
        ...
        { title: "خزانات مياه", category: "خزانات", desc: "خزانات صناعية مُحكمة الإغلاق لنقل وتخزين المياه بأعلى معايير السلامة والجودة.", tags: ["خزانات", "مياه"], image: "/products/tanks.jpg" },
        { title: "خزانات وقود", category: "خزانات", desc: "خزانات صناعية مُحكمة الإغلاق لنقل المواد البترولية والوقود بأعلى معايير السلامة والجودة.", tags: ["خزانات", "وقود", "بترول"], image: "/products/tanks.jpg" },
  ...
  en: {
    ...
    projects: {
      ...
      items: [
        ...
        { title: "Water Tanks", category: "Tanks", desc: "Sealed industrial tanks for safely transporting and storing water with the highest quality standards.", tags: ["Tanks", "Water"], image: "/products/tanks.jpg" },
        { title: "Fuel Tanks", category: "Tanks", desc: "Sealed industrial tanks for transporting petroleum products and fuel with the highest safety standards.", tags: ["Tanks", "Fuel", "Petroleum"], image: "/products/tanks.jpg" },
